...
from basicsr.data import prefetch_dataloader, paired_image_dataset
...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        ...
        '-opt', type = str, default = './Dehaze/Options/RealDehazing_FPM.yml', help = 'Path to option YAML file.')
    parser.add_argument(
        '--launcher',
...
def create_train_val_dataloader(opt, logger):
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            # train_set = paired_image_dataset(dataset_opt)
            train_set = create_dataset(dataset_opt)
            train_sampler = EnlargedSampler(train_set, opt['world_size'],
                                            opt['rank'], dataset_enlarge_ratio)
            # train_loader = prefetch_dataloader(
...
def main():
    ...
    if resume_state:  # resume training
        ...
        # model = image_restoration_model(opt)
